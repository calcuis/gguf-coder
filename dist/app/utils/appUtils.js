...
import { DELAY_COMMAND_COMPLETE_MS, TRUNCATION_RESULT_STRING_LENGTH, } from '../../constants.js';
...
export async function handleMessageSubmission(message, options) {
    const { customCommandCache, customCommandLoader, customCommandExecutor, onClearMessages, onEnterModelSelectionMode, onEnterProviderSelectionMode, onEnterThemeSelectionMode, onEnterModelDatabaseMode, onEnterConfigWizardMode, onEnterCheckpointLoadMode, onShowStatus, onHandleChatMessage, onAddToChatQueue, onCommandComplete, componentKeyCounter, setMessages, messages, setIsBashExecuting, setCurrentBashCommand, } = options; // Parse the input to determine its type
        ...
        try {
            ...
            try {
                ...
                result = {
                    ...
                    llmContext: resultString.length > TRUNCATION_RESULT_STRING_LENGTH
