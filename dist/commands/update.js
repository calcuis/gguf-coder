    ...
    handler: async (_args) => {
        ...
        try {
            ...
            if (updateInfo.hasUpdate) {
                ...
                logInfo('Downloading and installing the latest Coder update...', true);
                ...
                if (updateInfo.updateCommand) {
                    try {
                        ...
                        return React.createElement(SuccessMessage, {
                            message: 'Coder has been updated to the latest version. Please restart your session to apply the update.',
                            hideBox: true,
                        });
                    }
                    catch (err) {
