...
import { confDirMap, getClosestConfigFile, reloadAppConfig } from './index.js';
console.log(`\nindex.spec.ts`);
...
test('promptPath points to main-prompt.md', async (t) => {
    ...
    t.true(promptPath.includes('main-prompt.md'), 'promptPath should point to main-prompt.md');
    t.true(promptPath.includes('source/app/prompts'), 'promptPath should include source/app/prompts directory');
});
