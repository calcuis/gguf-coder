 ...
 */
function detectProvider(providerName, modelId) {
    ...
    if (lowerProvider.includes('ollama') ||
 ...
 */
export function createTokenizer(providerName, modelId) {
 ...
 */
export function createTokenizerForProvider(provider, modelId) {
    switch (provider) {
        case 'openai':
...
//# sourceMappingURL=tokenizer-factory.js.map