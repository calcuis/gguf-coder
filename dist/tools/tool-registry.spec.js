...
test('ToolRegistry - getFormatters returns record of formatters', t => {
    const registry = new ToolRegistry();
    const formatter1 = (o) => String(o);
    const formatter2 = (o) => String(o);
    registry.registerMany([
...
test('ToolRegistry - getValidators returns record of validators', t => {
    const registry = new ToolRegistry();
    const validator1 = async () => ({ valid: true });
    const validator2 = async () => ({ valid: false, error: 'test error' });
    registry.registerMany([
...
test('ToolRegistry - getNativeTools returns record of native tools', t => {
    const registry = new ToolRegistry();
    const tool1 = { execute: async () => 'test 1' };
    const tool2 = { execute: async () => 'test 2' };
    registry.registerMany([
...
test('ToolRegistry - fromRegistries creates registry from records', t => {
    const handler1 = async () => 'test';
    const handler2 = async () => 'test';
    const formatter1 = (o) => String(o);
    const validator1 = async () => ({ valid: true });
    const tool1 = { execute: async () => 'test' };
    const tool2 = { execute: async () => 'test' };
...
test('ToolRegistry - fromRegistries skips tools without matching handlers', t => {
    const handler = async () => 'test';
    const tool = { execute: async () => 'test' };
    const registry = ToolRegistry.fromRegistries({ tool1: handler }, // Only has handler for tool1
...
//# sourceMappingURL=tool-registry.spec.js.map