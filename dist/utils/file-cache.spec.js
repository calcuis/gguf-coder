...
import { getCachedFileContent, invalidateCache, clearCache, getCacheSize, MAX_CACHE_SIZE, } from './file-cache.js';
...
test('getCachedFileContent - throws on non-existent file', async (t) => {
    await t.throwsAsync(async () => getCachedFileContent('/non/existent/file.txt'), { code: 'ENOENT' });
});
...
//# sourceMappingURL=file-cache.spec.js.map